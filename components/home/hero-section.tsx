      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-4.5rem)] max-w-7xl items-center gap-14 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-28">
        <div>
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-zinc-600">
            Explore local restaurants, read genuine customer experiences, and
            share your own dining stories with the DineRate community.
          </p>
          ...
          <div className="mt-10 flex flex-wrap gap-x-8 gap-y-3 text-sm text-zinc-600">
            <p>
              <strong className="text-zinc-950">4.9/5</strong> average rating
            </p>
            <p>
              <strong className="text-zinc-950">500+</strong> community reviews
            </p>
          </div>
        </div>
            ...
            <div className="rounded-3xl bg-white p-6 shadow-lg">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="rounded-2xl bg-orange-50 px-3 py-2 text-center">
                  <p className="font-bold text-orange-600">4.8</p>
                  <p className="text-xs text-zinc-500">Rating</p>
                </div>
              </div>

              <div className="my-6 h-44 rounded-2xl bg-gradient-to-br from-zinc-800 via-zinc-700 to-orange-900 p-5">
                <div className="flex h-full items-end">
                  <p className="max-w-xs text-lg font-semibold text-white">
                    Authentic flavours, welcoming atmosphere, unforgettable
                    meals.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-2xl bg-zinc-50 p-4">
                <div className="flex items-center justify-between">
                  <p className="font-semibold text-zinc-900">Latest review</p>
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-600">
                  “Wonderful food and friendly service. I would definitely
                  visit again.”
                </p>
              </div>
            </div>
